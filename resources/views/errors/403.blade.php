    ...
    <div class="max-w-md w-full text-center">
        ...
        <div class="relative inline-block mb-8">
            <div class="w-32 h-32 bg-white rounded-[40px] shadow-2xl shadow-blue-200/50 flex items-center justify-center rotate-3 hover:rotate-0 transition-transform duration-500 group">
                <div class="w-24 h-24 bg-red-50 rounded-[32px] flex items-center justify-center group-hover:bg-red-100 transition-colors">
                    <i data-lucide="shield-alert" class="w-12 h-12 text-red-500 animate-bounce"></i>
                </div>
            </div>
            <!-- Decorative dots -->
        ...
        <div class="space-y-4 mb-10">
            ...
            <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Access Forbidden</h2>
            <p class="text-sm text-gray-500 leading-relaxed max-w-[280px] mx-auto font-medium">
                Sorry, you don't have permission to access this page. It's restricted to authorized users only.
            </p>
        </div>
